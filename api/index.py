...
def handle_callback_query(query):
    ...
    if data.startswith("retry:"):
        ...
        tg_api("answerCallbackQuery", {"callback_query_id": callback_id, "text": "بجرب قراءة الصورة مرة تانية…"})
        ...
        if not info:
            tg_api("answerCallbackQuery", {
                "callback_query_id": callback_id,
                "text": "لسه مش قادر أقرأ الكود بدقة",
                "show_alert": True,
            })
            return
        ...
        tg_api("answerCallbackQuery", {"callback_query_id": callback_id, "text": "تمت إعادة القراءة ✅"})
        return
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self._send_json(200, {
            "ok": True,
            "message": "Fr3oon Helper Bot V12 polished cards is running",
