...
BAD_WORDS = [
    "احا", "أحا", "احه", "أحه",
    "خول", "خوال", "خ*ل",
    "متناك", "متناكه", "متناكة", "متناكه", "متناكين",
    "منيوك", "منيوكة", "منيوكه",
    "شرموط", "شرموطة", "شرموطه", "شراميط",
    "عرص", "معرص", "معرصين",
    "كس", "كسم", "كسمك", "كسمه", "كسمها", "كسمين",
    "زبر", "زب", "زبي",
    "طيز", "طيزك", "طيزه", "طيزها",
    "نيك", "انيك", "ينكح", "منيك",
    "لبوة", "لبوه",
...
class handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        self._send_json(200, {
            ...
            "rules": "text and photos allowed, links/profanity/spam blocked"
        })
